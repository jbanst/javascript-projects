...
//I already did this above with: dna = dna.trim().toUpperCase();
console.log(dna);
...
dnaTwo = dnaTwo.replace('CAT', 'taco cat');
console.log(`After years of research, scientists found a hidden code inside of a man's DNA.\nThe DNA strand reads as ${dnaTwo}`);
